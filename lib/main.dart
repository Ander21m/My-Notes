...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(appBar: AppBar(title: const Text("Testing bloc")),
    body: BlocConsumer<CounterBloc,CounterState>(
      ...
      builder:(context, state) {
        ...
        return Column(children: [
          ...
          TextField(controller: _controller,decoration: const InputDecoration(hintText: "Enter a number here"),keyboardType: TextInputType.number,),
